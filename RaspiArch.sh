...
sudo mkfs.vfat ${ArchPiDevice}p1 &>/dev/null
sudo mkdir ArchPiSDBoot
sudo mount ${ArchPiDevice}p1 ArchPiSDBoot >/dev/null

sudo mkfs.ext4 ${ArchPiDevice}p2 &>/dev/null
sudo mkdir ArchPiSDRoot
sudo mount ${ArchPiDevice}p2 ArchPiSDRoot >/dev/null
